...
class CategoriesHistory(db.Model):
    ...
    hist_id = db.Column(db.BigInteger, primary_key=True, nullable=False)
...
class Categories(db.Model):
    ...
    category_status_id = db.Column(db.Integer, nullable=False)
...
class Stores(db.Model):
    ...
    store_status_id = db.Column(db.Integer, nullable=False)
...
class Orders(db.Model):
    ...
    order_tot_price = db.Column(db.DECIMAL(10, 2), nullable=False)
...
class ProductsServices(db.Model):
    ...
    product_service_id = db.Column(db.Integer, primary_key=True, nullable=False)
    product_service_name = db.Column(db.String(100), nullable=False)
    product_service_category_id = db.Column(db.Integer, nullable=False)
    product_service_status_id = db.Column(db.Integer, nullable=False)
...
class StatesRegions(db.Model):
    ...
    state_region_id = db.Column(db.Integer, primary_key=True, nullable=False)
...
class Cities(db.Model):
    ...
    state_region_id = db.Column(db.Integer, nullable=False)
...
class StoreProductsServices(db.Model):
    ...
    product_service_id = db.Column(db.Integer, nullable=False)
...
class CustomerAddresses(db.Model):
    ...
    address_status_id = db.Column(db.Integer, nullable=False)
...
class OrderDetails(db.Model):
    ...
    order_id = db.Column(db.Integer, primary_key=True, nullable=False)
    store_product_service_id = db.Column(db.Integer, primary_key=True, nullable=False)
    product_service_quantity = db.Column(db.Integer, nullable=False)
    product_service_price = db.Column(db.DECIMAL(10, 2), nullable=False)
    product_service_tot_price = db.Column(db.DECIMAL(10, 2), nullable=False)
    product_service_status_id = db.Column(db.Integer, nullable=False)
    product_service_filled_quantity = db.Column(db.Integer, server_default=text("'0'"), nullable=False)
    product_service_filled_tot_price = db.Column(db.DECIMAL(10, 2), server_default=text("'0.00'"), nullable=False)
