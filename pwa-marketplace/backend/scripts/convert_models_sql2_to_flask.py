"""
Convert a SQLAlchemy 2.0 DeclarativeBase models file (sqlacodegen style)
into a Flask-SQLAlchemy `db.Model` based models.py file.

Usage:
  python scripts/convert_models_sql2_to_flask.py \
    --in app/shared/models_sql2orm_plainsqlalchemy2.py \
    --out app/shared/models_plainsqlalchemy22flasksqlalchemy.py
...
def main():
    ...
    parser.add_argument('--in', dest='src', default='app/shared/models_sql2orm_plainsqlalchemy2.py')
    parser.add_argument('--out', dest='dst', default='app/shared/models_plainsqlalchemy22flasksqlalchemy.py')
...
# When script is imported as a module, name is set to the module's name. eg. 'convert_models_sql2_to_flask'
