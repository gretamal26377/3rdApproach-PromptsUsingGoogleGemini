...
Usage:
  python scripts/convert_models_sql2_to_flask.py \
    --in app/shared/models_sql2orm_plain-sqlalchemy2.py \
    --out app/shared/models_plain-sqlalchemy22flask-sqlalchemy.py
...
def main():
    ...
    parser.add_argument('--in', dest='src', default='app/shared/models_sql2orm_plain-sqlalchemy2.py')
    parser.add_argument('--out', dest='dst', default='app/shared/models_plain-sqlalchemy22flask-sqlalchemy.py')
